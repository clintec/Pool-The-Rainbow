...
## Underdog Out-of-Order Ball
This is a strategy that may assist the underdog with capturing a tie.  For this stategy to be successful, the underdog should have a very limited amount of balls remaining on the table (likely just 2).  If the lowest available ball is within the Kitchen and the underdog has a better opportunity to sink the higher of the two balls, the underdog can sink the higher of the two balls.  This will result in a scratch.  This scratch will force the contender to target the single remaining ball, but the cue must first leave the kitchen and return to strike the final ball.  If the contender moves the final ball without sinking it, then the underdog will likely be left with a better opportunity at sinking the final ball.  
# Definitions
* Breaker
